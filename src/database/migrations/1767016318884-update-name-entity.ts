...
export class UpdateNameEntity1767016318884 implements MigrationInterface {
    name = 'UpdateNameEntity1767016318884'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`files\` CHANGE \`mimeType\` \`mime_type\` varchar(255) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`files\` ADD \`mime_type\` varchar(255) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`files\` CHANGE \`mime_type\` \`mimeType\` varchar(255) NOT NULL`);
    }
